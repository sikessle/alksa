...
public class WhereClauseLogicChecker extends QueryChecker {
	...
	protected LogEntry check(SelectStatementToken subject,
		...
		// }
		//
		// Set<ColumnNameToken> learnedColumnNames =
		// copyColumnNameTokens(learned
		// .getColumnList());
		//
		// Set<ColumnNameToken> subjectComparisonColumnNames =
		// getInvolvedColumnNamesRecursive(copyComparisonFilterTokens(subject
		// .getWhereClause()));
		//
		// if (!isSubset(learnedColumnNames, subjectComparisonColumnNames)) {
		// return
		// createLogEntry("columns used which are not stated in the column list");
		// }
